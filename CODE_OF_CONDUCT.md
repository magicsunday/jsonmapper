...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact project maintainers through private repository contact channels (for example, maintainer contact options on GitHub). Do not use public issues or pull requests for Code of Conduct reports.
